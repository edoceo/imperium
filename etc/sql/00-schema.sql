...
--  --
--  -- TOC entry 254 (class 1247 OID 42020)
--  -- Dependencies: 6 1602
...
--  
--  --
--  -- TOC entry 292 (class 1247 OID 42023)
--  -- Dependencies: 6 1603
...
--  
--  --
--  -- TOC entry 294 (class 1247 OID 42026)
--  -- Dependencies: 6 1604
...
--  
--  --
--  -- TOC entry 20 (class 1255 OID 42027)
--  -- Dependencies: 6
...
--
-- TOC entry 1605 (class 1259 OID 42028)
-- Dependencies: 6
...
--
-- TOC entry 1626 (class 1259 OID 42094)
-- Dependencies: 6 1624
-- Name: auth_user_id_seq1; Type: SEQUENCE; Schema: public; Owner: -
--
...
-- Dependencies: 1626
-- Name: auth_user_id_seq1; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- TOC entry 1632 (class 1259 OID 42114)
-- Dependencies: 6
-- Name: base_country; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE base_country (
    ...
    name_fr character varying(128)
);


--
-- TOC entry 1633 (class 1259 OID 42117)
-- Dependencies: 6
-- Name: base_country_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE base_country_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
--
-- TOC entry 1639 (class 1259 OID 42139)
-- Dependencies: 6
-- Name: base_kind_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE base_kind_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
--
-- TOC entry 1646 (class 1259 OID 42166)
-- Dependencies: 6
-- Name: base_task_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE base_task_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
--
-- TOC entry 1647 (class 1259 OID 42168)
-- Dependencies: 1973 6
-- Name: base_task; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE base_task (
    id integer DEFAULT nextval('base_task_id_seq'::regclass) NOT NULL,
    auth_user_id integer NOT NULL,
...
--
-- TOC entry 1652 (class 1259 OID 42186)
-- Dependencies: 6
...
--
-- TOC entry 1654 (class 1259 OID 42190)
-- Dependencies: 6
...
--
-- TOC entry 1655 (class 1259 OID 42192)
-- Dependencies: 6
-- Name: client_list_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE client_list_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
--
-- TOC entry 1656 (class 1259 OID 42194)
-- Dependencies: 6
-- Name: client_list_item_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE client_list_item_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
--
-- TOC entry 1657 (class 1259 OID 42196)
-- Dependencies: 6
...
--
-- TOC entry 1664 (class 1259 OID 42224)
-- Dependencies: 1761 6
-- Name: general_ledger; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW general_ledger AS
    SELECT a.id AS account_id, c.id AS account_journal_id, b.id AS account_ledger_id, a.code AS account_code, a.full_code AS account_full_code, a.name AS account_name, a.full_name AS account_full_name, c.date, b.amount, c.kind, c.note, b.link_to, b.link_id FROM ((account a JOIN account_ledger b ON ((a.id = b.account_id))) JOIN account_journal c ON ((c.id = b.account_journal_id)));
...
--
-- TOC entry 1674 (class 1259 OID 42265)
-- Dependencies: 6
...
--
-- TOC entry 1675 (class 1259 OID 42267)
-- Dependencies: 6
-- Name: service_order_item_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE service_order_item_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
CREATE TABLE timesheet (
    ...
    duration interval,
    time_i timestamp without time zone,
    time_o timestamp without time zone,
    name character varying(64)
);
...
--
-- TOC entry 1680 (class 1259 OID 42287)
-- Dependencies: 6 1679
-- Name: work_order_item_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE work_order_item_id_seq
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
-- Dependencies: 1680
-- Name: work_order_item_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE work_order_item_id_seq OWNED BY workorder_item.id;
...
-- Dependencies: 1682
-- Name: workorder_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- TOC entry 1683 (class 1259 OID 42298)
-- Dependencies: 1762 6
-- Name: workorder_item_invoice_item; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW workorder_item_invoice_item AS
    SELECT woi.id, woi.auth_user_id, woi.workorder_id, ivi.invoice_id, woi.status, woi.kind, woi.date, woi.name, woi.note, woi.a_quantity AS quantity, woi.a_unit AS unit, woi.a_rate AS rate FROM (workorder_item woi LEFT JOIN invoice_item ivi ON ((woi.id = ivi.workorder_item_id)));
...
--
-- TOC entry 2030 (class 2606 OID 42352)
-- Dependencies: 1647 1647
-- Name: base_todo_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY base_task
...
--
-- TOC entry 2054 (class 2606 OID 42380)
-- Dependencies: 1681 1681
-- Name: work_order_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
-- Completed on 2010-10-26 20:50:33 PDT
